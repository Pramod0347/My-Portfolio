            ...
            {experiences.map((exp, idx) => (
                <div key={idx} className="my-6">
                    <div className="flex items-start gap-2 mb-2">
                        <span className="bg-yellow-500 w-5 h-5 rounded-full flex items-center justify-center text-white shadow-md mt-1">
                            <Briefcase size={14} />
                        </span>
                        <div>
                            <h3 className="font-bold text-gray-900 dark:text-stone-100 text-base lg:text-lg leading-snug">
                                {exp.title}
                            </h3>
                    ...
                    <ul className="list-disc pl-6 text-sm lg:text-base space-y-1 text-gray-800 dark:text-gray-300 leading-relaxed">
