...
import {
    ...
    SiNodedotjs, SiMysql,
    SiTailwindcss, SiGit, SiPostman, SiFigma
  } from 'react-icons/si';
...
const Skills = () => {
  ...
  return (
    <div className="w-full mt-6">
        <h2 className="relative w-fit text-xl lg:text-2xl font-medium after:content-[''] after:block after:w-2/3 after:border-b-2 after:border-stone-300 after:dark:bg-gray-800 after:rounded-full">My Learnings & Skills</h2>
        <div className="grid grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-6 mt-4">
        {skills.map((skill, index) => {
            const Icon = skill.icon;
            return (
            <div key={index} className="flex flex-col items-center text-center p-3 rounded-2xl shadow-lg backdrop-blur-md bg-stone-100/30 dark:bg-stone-100/10 hover:scale-105 hover:shadow-xl transition duration-300 ease-in-out">
